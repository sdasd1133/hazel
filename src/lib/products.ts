...
export const products: Product[] = [
  {
    ...
    images: ["https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1571945153237-4929e783af4a?w=400&h=400&fit=crop"],
    sizes: ["S", "M", "L", "XL"],
    colors: ["검정", "흰색", "회색"],
    isFeatured: true,
    inStock: true,
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&h=400&fit=crop"],
    sizes: ["S", "M", "L", "XL"],
    colors: ["검정", "베이지", "네이비"],
    inStock: true,
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1542272604-787c3835535d?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400&h=400&fit=crop"],
    sizes: ["28", "30", "32", "34"],
    colors: ["중청", "연청", "흑청"],
    isFeatured: true,
    inStock: true,
